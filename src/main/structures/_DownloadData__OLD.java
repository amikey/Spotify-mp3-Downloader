...
class _DownloadData__OLD {
	public InputStream input;
	public int size = 0;
	public _DownloadData__OLD(String strUrl) throws Exception { //if throws error, stop because IDK what to do with it
...
//		}
	...
	public _DownloadData__OLD(InputStream input, int size) {
		this.input = input;
		this.size = size;
	}
}
